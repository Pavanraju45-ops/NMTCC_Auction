...
# =========================================================
    ...
    if st.button("Next"):
        ...
        # RANDOMIZE PLAYERS INSIDE EACH SET
...
# =========================================================
    ...
    if st.session_state.rtm_enabled:
        ...
        for t, val in st.session_state.rtm_remaining.items():
            st.write(f"{t}: {val}")
    ...
    if st.session_state.rtm_stage == "ask":
        ...
        st.warning("RTM Option Available")
        ...
        counter = st.number_input("Counter Price", min_value=st.session_state.rtm_price)

        if st.button("Confirm Counter"):
            ...
            st.session_state.teams[old_team]["purse"] -= counter
